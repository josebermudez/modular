...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'for_archivo'); ?>
		<?php 
		$csrfToken = Yii::app()->request->csrfToken;
		$urlBorrarArchivo = $this->createUrl('/formato/formato/borrarArchivo');
			$this->widget('ext.dropzone.EDropzone', array(
				'model' => $model,
				'attribute' => 'for_archivo',
				'url' => $this->createUrl('/formato/formato/subirArchivo'),
				'mimeTypes' => array('application/rtf'),	
